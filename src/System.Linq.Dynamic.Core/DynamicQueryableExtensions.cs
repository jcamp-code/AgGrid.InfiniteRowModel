...
namespace System.Linq.Dynamic.Core
{
    ...
    public static class DynamicQueryableExtensions
    {
        ...
        public static IOrderedQueryable<TSource> OrderBy<TSource>(this IQueryable<TSource> source, ParsingConfig config, string ordering, params object?[] args)
        {
            ...
            {
                return InternalOrderBy<TSource>(source, ParsingConfig.Default, ordering, args[0]!, args);
            }

            return InternalOrderBy<TSource>(source, config, ordering, null, args);
        }
        ...
        public static IOrderedQueryable<TSource> OrderBy<TSource>(this IQueryable<TSource> source, string ordering, params object?[] args)
        {
            ...
            return InternalOrderBy<TSource>(source, ParsingConfig.Default, ordering, null, args);
        }
        ...
        {
            return (IOrderedQueryable<TSource>)InternalOrderBy<TSource>(source, config, ordering, comparer, args);
        }
        ...
        {
            return InternalOrderBy<TSource>(source, ParsingConfig.Default, ordering, comparer, args);
        ...
        internal static IOrderedQueryable<TSource> InternalOrderBy<TSource>(IQueryable source, ParsingConfig config, string ordering, object? comparer, params object?[] args)
        {
            Check.NotNull(source);
            Check.NotNull(config);
            Check.NotEmpty(ordering, nameof(ordering));
            ...
            var optimized = OptimizeExpression(queryExpr);
            return (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(optimized);
        }
        ...
        public static IQueryable<TSource> Where<TSource>(this IQueryable<TSource> source, string predicate, params object?[] args)
        {
            ...
            bool createParameterCtor = SupportsLinqToObjects(ParsingConfig.Default, source);
            LambdaExpression lambda = DynamicExpressionParser.ParseLambda(ParsingConfig.Default, createParameterCtor, source.ElementType, null, predicate, args);
            ...
            return source.Provider.CreateQuery<TSource>(optimized);
        }
